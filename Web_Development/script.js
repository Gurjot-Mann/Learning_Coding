...
function populated(c1,c2)
{
  ...
  var c2=document.getElementById(c2);
   ...
   else if (c1.value == "computer science & information technology")
   { 
     var optionArray = ["select|Select","comp science and engineering|Computer Science and Engineering","bsc comp science|Bsc Comp Science","diploma in comp science|Diploma in Comp Science"];
   }
